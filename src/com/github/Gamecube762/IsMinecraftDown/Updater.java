 ...
 * <br>
 * It is a <b>BUKKIT POLICY</b> that you include a boolean value in your config that prevents the auto-com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater from running <b>AT ALL</b>.
 * <br>
 * If you fail to include this option in your config, your plugin will be <b>REJECTED</b> when you attempt to submit it to dev.bukkit.org.
 * <p/>
 * An example of a good configuration option would be something similar to 'auto-update: true' - if this value is set to false you may NOT run the auto-com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater.
 * <br>
...
public class Updater {
    ...
    public enum UpdateResult {
        /**
         * The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater found an update, and has readied it to be loaded the next time the server restarts/reloads.
         */
        SUCCESS,
        /**
         * The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater did not find an update, and nothing was downloaded.
         */
        NO_UPDATE,
        /**
        ...
        DISABLED,
        /**
         * The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater found an update, but was unable to download it.
         */
        FAIL_DOWNLOAD,
        /**
         * For some reason, the com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater was unable to contact dev.bukkit.org to download the file.
         */
        FAIL_DBO,
        /**
        ...
        FAIL_NOVERSION,
        /**
         * The id provided by the plugin running the com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater was invalid and doesn't exist on DBO.
         */
        FAIL_BADID,
        /**
        ...
        FAIL_APIKEY,
        /**
         * The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater found an update, but because of the UpdateType being set to NO_DOWNLOAD, it wasn't downloaded.
         */
        UPDATE_AVAILABLE
    }
    ...
    /**
     * Initialize the com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater
     *
    ...
    public Updater(Plugin plugin, int id, File file, UpdateType type, boolean announce) {
        ...
        if (!updaterConfigFile.exists()) {
            try {
                ...
                plugin.getLogger().severe("The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater could not create a configuration in " + updaterFile.getAbsolutePath());
                e.printStackTrace();
            }
        }
        ...
        if (this.config.get("api-key", null) == null) {
            ...
            try {
                ...
                plugin.getLogger().severe("The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater could not save the configuration in " + updaterFile.getAbsolutePath());
                e.printStackTrace();
            }
        }
    ...
    private void saveFile(File folder, String file, String u) {
        ...
        try {
            ...
            this.plugin.getLogger().warning("The auto-com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater tried to download a new update, but was unsuccessful.");
    ...
    private void unzip(String file) {
        try {
            ...
            this.plugin.getLogger().warning("The auto-com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater tried to unzip a new update file, but was unsuccessful.");
            this.result = UpdateResult.FAIL_DOWNLOAD;
            ex.printStackTrace();
        }
    ...
    private boolean read() {
        try {
            ...
            if (array.size() == 0) {
                this.plugin.getLogger().warning("The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater could not find any files for the project id " + this.id);
                this.result = UpdateResult.FAIL_BADID;
                return false;
            }
            ...
            if (e.getMessage().contains("HTTP response code: 403")) {
                ...
                this.plugin.getLogger().warning("The com.github.Gamecube762.IsMinecraftDown.net.gravitydevelopment.updater could not contact dev.bukkit.org for updating.");
